import java.sql.*;
import javax.swing.*;
public class deleteSuppliers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Suppliers");

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(102, 51, 0));
        jLabel2.setText("Enter the Supplier ID:");
        ...
        clearBT.setForeground(new java.awt.Color(0, 102, 0));
    ...
    private void deleteBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTActionPerformed
        ...
        try
        {
            String data = "DELETE FROM Suppliers WHERE supplierID = "+id+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteSuppliers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deleteSuppliers().setVisible(true);
            }
        });
    }
