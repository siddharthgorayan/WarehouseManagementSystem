import java.sql.*;
import javax.swing.*;
public class deleteProductsWM extends javax.swing.JFrame {

    Connection con;
    Statement stmt;
    public deleteProductsWM() {
        initComponents();
        Connect();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter the Product ID:");
    ...
    private void deleteBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTActionPerformed
        ...
        try
        {
            String data = "DELETE FROM Products WHERE productID = "+id+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteProductsWM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deleteProductsWM().setVisible(true);
            }
        });
    }
