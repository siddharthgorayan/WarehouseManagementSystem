...
import javax.swing.*;
import java.time.*;
public class transactionIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sNameTF.setForeground(new java.awt.Color(102, 51, 0));
    ...
    private void proceedBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proceedBTActionPerformed
        ...
        try
        {
            ...
            String data = "INSERT INTO transactionIN(productID, productName, cost, units, supplierID, supplierName, totalCost, Date, Time) VALUES("+pID+",'"+pName+"', "+cost+","+UNITS+", "+sID+", '"+sName+"', "+tCost+", '"+DATE+"', '"+TIME+"')";
            stmt.executeUpdate(data);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transactionIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new transactionIN().setVisible(true);
            }
        });
    }
