import java.sql.*;
import javax.swing.*;
public class updateSalesManagers extends javax.swing.JFrame {

    Connection con;
    Statement stmt;
    ResultSet result;
    public updateSalesManagers() {
        initComponents();
        Connect();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Sales Manager");
    ...
    private void updateBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBTActionPerformed
        ...
        try
        {
            String data = "UPDATE SalesManagers SET SMName = '"+name+"', Contact = '"+contact+"', Email = '"+email+"', Address = '"+address+"', Since = '"+since+"' WHERE SMID = "+searchTF.getText()+"";
    ...
    private void searchBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBTActionPerformed
        ...
        try
        {
            String data = "SELECT * FROM SalesManagers WHERE SMID = "+id+"";
            result = stmt.executeQuery(data);

            if(result.next())
            {
                nameTF.setText(result.getString("SMName"));
            ...
            {
                JOptionPane.showMessageDialog(this, "Sales Manager not Found.");
            }
        }
        catch(Exception ex)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateSalesManagers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updateSalesManagers().setVisible(true);
            }
        });
    }
