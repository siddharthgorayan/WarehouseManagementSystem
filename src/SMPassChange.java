import java.sql.*;
import javax.swing.*;
public class SMPassChange extends javax.swing.JFrame {
    ...
    private void doneTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doneTFActionPerformed
        ...
        try
        {
            ...
            if(result.next())
            {
                if(oPass.equals(result.getString("password")))
                {
                    if(nPass.equals(cPass))
                    {
                        try
                        {
                            String data1 = "UPDATE SalesManagers SET password = '"+nPass+"' WHERE SMID = '"+id+"'";
            ...
            {
                JOptionPane.showMessageDialog(this, "Sales Manager not found! Try Again.");
            }
        }
        catch(Exception ex)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SMPassChange.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SMPassChange().setVisible(true);
            }
        });
    }
