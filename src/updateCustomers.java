...
public class updateCustomers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sinceTF.setForeground(new java.awt.Color(153, 102, 0));
        ...
        jScrollPane1.setForeground(new java.awt.Color(153, 102, 0));
        ...
        nameTF.setForeground(new java.awt.Color(153, 102, 0));

        conTF.setFont(new java.awt.Font("Futura", 0, 18)); // NOI18N
        conTF.setForeground(new java.awt.Color(153, 102, 0));

        emTF.setFont(new java.awt.Font("Futura", 0, 18)); // NOI18N
        emTF.setForeground(new java.awt.Color(153, 102, 0));
    ...
    private void updateBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBTActionPerformed
        ...
        try
        {
            String data = "UPDATE Customers SET CustomerName = '"+name+"', Contact = '"+contact+"', Email = '"+email+"', Address = '"+address+"', Since = '"+since+"' WHERE CustomerID = "+searchTF.getText()+"";
    ...
    private void backBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBTActionPerformed
        // TODO add your handling code here:
        dispose();
        CustomersPage objBack = new CustomersPage();
    ...
    private void searchBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBTActionPerformed
        ...
        try
        {
            String data = "SELECT * FROM Customers WHERE CustomerID = "+id+"";
            result = stmt.executeQuery(data);

            if(result.next())
            {
                nameTF.setText(result.getString("CustomerName"));
