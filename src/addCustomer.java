...
public class addCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        saveBT.setForeground(new java.awt.Color(0, 102, 51));
        saveBT.setText("Save");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(idTF, javax.swing.GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                                    .addComponent(nameTF)
                                    .addComponent(conTF)
                                    .addComponent(emTF))
                                .addGap(18, 18, 18)
    ...
    private void saveBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBTActionPerformed
        ...
        try
        {
            String data = "INSERT INTO Customers(CustomerID, CustomerName, Contact, Address, Email, Since) VALUES("+id+", '"+name+"', '"+contact+"', '"+address+"', '"+email+"', '"+since+"')";
