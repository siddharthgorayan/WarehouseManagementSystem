...
public class viewCustomers extends javax.swing.JFrame {
    ...
    public void loadData()
    {
        try
        {
            String Data = "SELECT * FROM Customers";
            result = stmt.executeQuery(Data);
            DefaultTableModel model = (DefaultTableModel)customersTable.getModel();
            model.setRowCount(0);
            while(result.next())
            {
                model.addRow(new Object[]{result.getString("CustomerID"), result.getString("CustomerName"), result.getString("Contact"), result.getString("Email"), result.getString("Address"), result.getString("Since")});
            }
        }
        catch(Exception ex)
        {
    ...
    private void initComponents() {
        ...
        customersTable.setFont(new java.awt.Font("Futura", 0, 14)); // NOI18N
        customersTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Name", "Contact", "Email", "Address", "Since"
            }
        ) {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(3, 3, 3)
                        .addComponent(backBT, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)))
