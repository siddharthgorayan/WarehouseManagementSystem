...
public class updateSuppliers extends javax.swing.JFrame {
    ...
    private void updateBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBTActionPerformed
        ...
        try
        {
            String data = "UPDATE Suppliers SET supplierName = '"+name+"', Contact = '"+contact+"', Email = '"+email+"', Address = '"+address+"', Since = '"+since+"' WHERE supplierID = "+searchTF.getText()+"";
    ...
    private void searchBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBTActionPerformed
        ...
        try
        {
            String data = "SELECT * FROM Suppliers WHERE supplierID = "+id+"";
            result = stmt.executeQuery(data);
        
            if(result.next())
            {
                nameTF.setText(result.getString("supplierName"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updateSuppliers().setVisible(true);
            }
        });
    }
