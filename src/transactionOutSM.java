import java.sql.*;
import javax.swing.*;
public class transactionOutSM extends javax.swing.JFrame {

    Connection con;
    Statement stmt;
    ResultSet result;
    public transactionOutSM() {
        initComponents();
        Connect();
    }
    ...
    private void proceedBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proceedBTActionPerformed
        ...
        try
        {
            ...
            String data = "INSERT INTO transactionOUT(productID, productName, cost, units, customerID, customerName, totalCost) VALUES("+pID+",'"+pName+"', "+cost+","+UNITS+", "+cID+", '"+cName+"', "+tCost+")";
            stmt.executeUpdate(data);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transactionOutSM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new transactionOutSM().setVisible(true);
            }
        });
    }
