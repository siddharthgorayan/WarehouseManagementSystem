import java.sql.*;
import javax.swing.*;
public class deleteSalesManager extends javax.swing.JFrame {

    Connection con;
    Statement stmt;
    public deleteSalesManager() {
        initComponents();
        Connect();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Sales Managers");
        ...
        IDTF.setForeground(new java.awt.Color(153, 51, 0));
    ...
    private void deleteBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTActionPerformed
        ...
        try
        {
            String data = "DELETE FROM SalesManagers WHERE SMID = "+id+"";
            stmt.executeUpdate(data);
            JOptionPane.showMessageDialog(this, "Sales Manager has been Deleted successfully.");
        }
        catch(Exception ex)
        {
            JOptionPane.showMessageDialog(this, ex.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteSalesManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deleteSalesManager().setVisible(true);
            }
        });
    }
